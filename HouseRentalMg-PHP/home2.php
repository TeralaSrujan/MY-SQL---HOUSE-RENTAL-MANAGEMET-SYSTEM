      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="addrating.html">addRating</a></li>
          </ul>
        </li>
...
<br>
  ...
  <div class="col-lg-3">
<div class="card colo-md-4" style="width:250px">
  <img class="card-img-top" src="img/home22.jpg" alt="Card image" width="250px;" height="190px;">
  <div class="card-body">
    <center><h4 class="card-title"><b>Payment</b></h4><br>
    <p class="card-text">This page provides gateway to pay bills.</p><br>
    
    <a href="https://rzp.io/l/0oHRa2J0" class="btn btn-primary">See Details</a></center><br>
  </div>
</div>
<br>
